                    ...
                    <form class="col-md-12" method="post" href="/">
                        <div style="display: table;float: left;width: 90%; margin-right: 5%;margin-left: 5%">
                            <div class="input-field">
                                ...
                                <input class="password" name="password" type="password" placeholder="Mật khẩu">
                                <input class="confirm_password" name="confirm_password" type="password" placeholder="Xác nhận lại mật khẩu">
