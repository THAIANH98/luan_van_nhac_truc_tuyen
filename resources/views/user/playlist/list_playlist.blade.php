        ...
        <div class="col-md-9">
            <table class="table">
                ...
                <tr style="text-align: center;position: relative">
                    <th style="width: 50px; line-height: normal;position: relative">
                        Xóa
                    ...
                    <th style="text-align: center;position: relative">Danh mục</th>
                    <th style="text-align: center;position: relative">Hình Ảnh</th>
                    <th style="text-align: center;position: relative ;width: 100px">Kích hoạt</th>
                ...
                @foreach($playlists as $counter => $playlist)
                    <tr>
                        <td>
                        ...
                        <td> {{ $counter+1 }} </td>
                        <td style="text-align: left;width: 200px;">{{$playlist->name}}</td>
                        <td style="width: 200px;">{{$playlist->menu_playlist->name}}</td>
                        <td style="width: 200px;">
                            <img src="{!! $playlist->thumb !!}" width="80px">
                        </td>
                        ...
                        <td>
                            <a class="btn btn-primary btn-sm" href="/user/playlist/edit/{{$playlist->id}}/{{$user->id}}" >
...
<script>
    ...
    function delid(){
        if(confirm('Dữ liệu xóa không thể khôi phục. Bạn có muốn xóa không?')){
            ...
            for($i=0 ; $i <$iddel.length;$i++){
                if($iddel[$i].checked===true){
                    removeRow($iddel[$i].value,'/user/delete/list_playlist');
                }
            }
        }
        location.reload();
