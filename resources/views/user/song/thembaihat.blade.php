...
@section('content')
    ...
    <div class="row">
       @include('user.sidebar')
        ...
        <div class="col-md-9">
            @include('admin.alert')
            <h3 style="color: #0689ba;margin-bottom: 5%">Thêm Bài Hát</h3>
            <form method="post">
                ...
                <div class="form-group col-12">
                    ...
                    <input type="text" class="form-control" id="name" value="" name="name" placeholder="Nhập tên bài hát">
                </div>

                <div class="form-group col-12">
                    <label for="music_artist">Nhạc Sĩ <font color="red"> (*)</font></label>
                    <input name="musican_name" class="form-control col-12" style="width: 870px" id="myinput" placeholder="Nhập tên nhạc sĩ" />
                </div>
                ...
                <div class="form-group col-12">
                    ...
                    <textarea class="form-control" name="lyric" id="lyric" rows="9"></textarea>
                </div>

                <div class="text-center col-12">
                    <button type="submit" id="btn-upload" class="btn btn-primary btn-upload">Tải lên</button>
                </div>
            </div>
                @csrf
            </form>
