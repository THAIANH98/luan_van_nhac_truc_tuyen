        ...
        <div class="row" style="background: #222222; position: relative;width: 100%;color: #ffffff;padding: 20px">
            <div class="col-md-2 align-content-center">
                <div class="singer-avatar">
                    <img width="110px" style="border-radius: 55px" height="110px" src="{{$singer->avatar}}">
                </div>
                <b class="singer-name" style="text-overflow:ellipsis;overflow: hidden;white-space:nowrap; font-size: 24px">{{$singer->name}}</b>
                @if($singer->birthday!=null)
                    <p>Sinh nhật: {{$singer->birthday}}</p>
                @endif
            </div>
            <div class="col-md-10">
                @if($singer->description!=null)
                    <p><b style="font-size: 24px">Tiểu sử:</b>{!! $singer->description !!}</p>
                @endif
            </div>
        </div>
    </div>
        ...
        <div class="col-md-3">
            ...
            <div class="list_singer_hot">
                ...
                <ul>
                    ...
                    <li>
                        <a href="/singer/{{$singer->id}}/{!! Str::slug($singer->name,'-') !!}.html" class="img" title="{{$singer->name}}">
                            <img src="{!! $singer->avatar !!}" title="{{$singer->name}}" alt="{{$singer->name}}">
                        </a>
                        <a href="/singer/{{$singer->id}}/{!! Str::slug($singer->name,'-') !!}.html" class="name_singer_main" title="{{$singer->name}}">{{$singer->name}}</a>
                    </li>
                    @endforeach
                </ul>
            </div>
