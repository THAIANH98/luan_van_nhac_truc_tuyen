...
@section('content')
    ...
    <div class="row">
        <div class="col-md-9">
            <nav id="navmenu">
                <ul>
                    <li id="bai-hat-moi" class="tab-current"><a onclick="categoryTab('album-moi','bai-hat-moi')"
                            class="bai-hat-moi" href="#"><span>Bài Hát mới</span></a></li>
                    <li id="album-moi" class=""><a onclick="categoryTab('bai-hat-moi','album-moi')" class="album-moi"
                            href="#"><span>Playlist mới</span></a></li>
                </ul>
            </nav>
            <br>
        ...
        @foreach ($playlists as $playlistgoiy)
            $(document).ready(function() {
                $("#playlist{{ $playlistgoiy->id }}").mouseenter(function() {
                    ...
                    document.getElementById('icon{{ $playlistgoiy->id }}playlist').style.visibility =
                        'visible';
                });
            });
            $(document).ready(function() {
