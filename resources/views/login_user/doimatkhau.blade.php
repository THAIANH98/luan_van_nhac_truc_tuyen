    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content modal-register modal-form">
            <div class="modal-header">
                <span class="modal-title span_h5" style="float: left;">Đổi mật khẩu</span>
                    ...
                    <form class="col-md-12" method="post" href="/">
                        <div style="display: table;float: left;width: 90%; margin-right: 5%;margin-left: 5%">
                            <div class="input-field">
                                <input class="password" id="password_curent" name="password_curent" type="password" placeholder="Nhập mật khẩu cũ">
                                <input class="password" id="password" name="password" type="password" placeholder="Nhập mật khẩu mới">
                                <input class="confirm_password" id="confirm_password" name="confirm_password" type="password" placeholder="Xác nhận lại mật khẩu mới">
                                <span style="color: red;display: none" id="loipass">Mật khẩu không giống nhau</span>
                                ...
                                <button class="btn my-2 my-sm-0 waves-effect waves-light" style="margin-left: 0px;width: 100%; padding: 10px" type="submit">Đổi mật khẩu</button>
...
<script>
    function show_pass(){
        if(document.getElementById('contact_csn').checked == true){
            ...
            document.getElementById('password_curent').type  = 'text';
            document.getElementById('confirm_password').type  = 'text';
        }else{
            document.getElementById('password').type = 'password';
            document.getElementById('password_curent').type  = 'password';
            document.getElementById('confirm_password').type  = 'password';
        }
    }

    document.querySelector('#confirm_password').addEventListener('change',checkpass);
    document.querySelector('#password').addEventListener('change',checkpass);
